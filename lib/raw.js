...
!function(exports){
  ...
  raw.models.set('tree', function(){
    ...
    var insideElements = tree.dimension('insideElements')
      .title('Inside Elements')
      .types(String)

    var colorInsideElements = tree.dimension('colorInsideElements')
  ...
  // Custom Tree
  raw.models.set('customTree', function(){
    ...
    data.forEach(function(d) {
      ...
      tree.nameColumnsInDimension = function () {
        return {
          hierarchy: hierarchy(),
          insideElements: insideElements(),
          colorInsideElements: colorInsideElements()
        }
      }
      ...
      leaf.color = color(d);
      leaf.label = label(d);
      leaf.insideElements = insideElements(d);
      leaf.colorInsideElements = colorInsideElements(d);
  ...
  raw.models.customTree = raw.models.get('customTree');
